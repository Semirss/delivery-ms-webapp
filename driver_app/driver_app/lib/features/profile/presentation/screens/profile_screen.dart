      ...
      body: BlocListener<AuthBloc, AuthState>(
        ...
        child: BlocBuilder<AuthBloc, AuthState>(
          builder: (context, state) {
            ...
            final ratingFuture = user == null
                ? Future<_RatingSummary>.value(const _RatingSummary.empty())
                : _loadRatingSummary('driver', user.id);

            return FutureBuilder<_RatingSummary>(
              future: ratingFuture,
              builder: (context, snapshot) {
                final rating = snapshot.data ?? const _RatingSummary.empty();
                final ratingValue = rating.hasRatings
                    ? rating.average.toStringAsFixed(1)
                    : 'New';
                final ratingLine = rating.hasRatings
                    ? '$ratingValue - Motorbike Driver'
                    : 'No ratings yet - Motorbike Driver';
                            ...
                            _buildSection(context, 'App Preferences', [
                              ...
                              _buildPreferenceTile(
                                ...
                                trailing: DropdownButton<String>(
                                  ...
                                  onChanged: (value) {
                                    if (value != null) {
                                      preferences.setLanguageCode(value);
                                    }
                                  },
                                ),
                              ),
