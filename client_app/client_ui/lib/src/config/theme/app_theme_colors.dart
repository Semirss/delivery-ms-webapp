...
extension AppThemeColors on BuildContext {
  ...
  Color get appBorder => _theme.colorScheme.outline.withValues(
        alpha: isAppDark ? 0.55 : 1,
      );

  Color get appTextPrimary => _theme.colorScheme.onSurface;

  Color get appTextSecondary => _theme.colorScheme.onSurface.withValues(
        alpha: isAppDark ? 0.72 : 0.62,
      );
}
